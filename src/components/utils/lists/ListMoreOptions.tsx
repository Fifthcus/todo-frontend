...
const ListMoreOptions = ({handleClick, id}: ListMoreOptionsProps) => {
    ...
    return (
        <>
            <section className='flex'>
                ...
                <img onClick={() => deleteTaskFromList(id)} className="p-2" src={Delete} alt="An icon to edit to do list item" />
                <img onClick={() => handleClick()} className="p-2" src={Close} alt="An icon to close the additional options menu." />
            </section>
        </>
    )
}
